...
public class BuildJS {
  ...
  private final static List<String> toRename = List.of("Button", "CheckBox", "ComboBox", "Component", "Frame", "Label", "Panel", "ProgressBar", "RadioButton", "Slider", "Spinner", "ToggleButton");
