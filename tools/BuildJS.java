...
public class BuildJS {
  ...
  private final static List<String> toRename = List.of("Button", "CheckBox", "ComboBox", "Component", "Dialog", "Frame", "Label", "Panel", "OptionPane", "ProgressBar", "RadioButton", "Slider", "Spinner", "TabbedPane", "TextField", "ToggleButton");
